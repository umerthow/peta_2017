...
<div class="row">
 ...
 <h3 class="breadcrumb">Detail Verifikasi Post Assement Level 3</h3>  
  ...
  <div class="col-md-2">
  <h5 class="text-right" style="padding-right: 10px;"><a href="<?php echo site_url('Verifikasi/convert_excel_ps/'.$training->id_tpddk) ?>" class="btn btn-default" role="button" target="_blank" download><span class="glyphicon glyphicon-print"> </span> Cetak Excel </a></h5> 
  </div> 
