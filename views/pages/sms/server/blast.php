           ...
           <?php $no=1;
            ...
            <?php if(!empty($row)) { ?>
               <td><?php echo $no++ ?> </td>
                ...
                <td><a href="<?php echo site_url('sms_gateway/deletegroups/'.$row->id_group.'') ?>" onclick="return confirm('Are you sure you want to delete this item?');" >delete</a></td>
...
<div class="modal fade" tabindex="-1" role="dialog" id="confirm-reject2">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo form_open('sms_gateway/deletegroups/') ?>
