...
<div class="col-md-12">
	...
	<?php echo form_open('Panel_user/insert_pre_pddk')?>
    <div class="panel-body">	
						       ...
						       <input type="hidden"  class="form-control" name="id_pengisi" value="2" />
						        <table class="table">
						        	<tr>
...
<div id="autoUpdate" class="autoUpdate">
							 ...
							 <?php if($result->status_bawahan == 0 ) { ?>
							...
							<?php } else { ?>
										...
										<div class="panel">
										 <div class="panel-body panel-success">
                                          <p class="text-center" style="font-size: 16px">Terima Kasih</p>
                                        

                                      <p class="text-center">Anda sudah Mengisi Form Evaluasi ini.</p><br/>
                                        <center>* * * </center> <br/></p>
