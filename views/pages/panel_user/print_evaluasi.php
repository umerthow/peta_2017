...
class PDF extends FPDF
{
        ...
        function Header()
          ...
          function Content($training,$detail,$detail_average)
          {
            ...
            //$pecah4 = explode(" ", $training->date);
          // $tanggal_cetak = $this->waktu->formatDate($pecah4[0],'id');
                         $this->Ln(-20);
                        $this->cell(65);
                        $this->Cell(60,10, 'NOMOR :PSDM/04/'.date('m').'/PB/00'.$training->id_tp.'', '0', 1, 'C');
                         $this->Ln(5);
                                $this->setFont('Arial','B',10);
                                $this->setFillColor(255,255,255); 
                 ...
                 $this->Ln(6);
                  ...
                  $jmlb = 0;
                   $this->cell(5);
                           $this->cell(130,80,'',1,0,'C',1);    
                           $this->cell(25,80,'',1,0,'C',1);
                            $this->cell(25,80,'',1,0,'C',1);
                    ...
                    $this->Ln(2);
                                ...
                                $this->cell(10);
                                    ...
                                    $this->cell(16,4, " ",0,0,'L',1);
                                    $this->setFont('Arial','B',10);
                                     $this->cell(15,4,$training->reason_apv,0,0,'L',1); 
                                     $this->Ln(6);
                                     $this->setFont('Arial','',10);
                                $this->cell(10);
                                    $this->cell(3,3, " ",1,0,'L',1);
                                   ...
                                   $this->cell(5);
                                    $this->cell(180,40, " ",1,0,'L',1);
                                      ...
                                      $this->cell(60,40, "",1,0,'L',1);
                                       $this->Ln(1);
                                       $this->cell(142);
                                        $this->cell(18,10, "Diusulkan / Penilai ",0,0,'L',1);
                                        $this->Ln(0);
                                       $this->cell(85);
                                       ...
                                       $this->cell(75);
                                        ...
                                        $this->Ln(0);
                                        $this->cell(145);
                                        $this->cell(30,10, $training->date,0,0,'R',0);
                                        $this->Ln(8);
                                        $this->cell(140);
                                         $this->cell(30,10, "(TTD)",0,0,'R',0);
                                         $this->Ln(13);
                                       $this->cell(14);
